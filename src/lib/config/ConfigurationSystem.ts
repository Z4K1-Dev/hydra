...
export class ConfigurationManager {
  ...
  private watchers: Map<string, Set<(changes: ConfigurationChange[], config: Configuration) => void>> = new Map();
  ...
  watch(path: string, callback: (changes: ConfigurationChange[], config: Configuration) => void): void {
  ...
  unwatch(path: string, callback: (changes: ConfigurationChange[], config: Configuration) => void): void {
